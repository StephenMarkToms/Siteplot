        ...
        app.config.globalProperties.$wind = {
            ...
            buttons: {
                base: {
                    ...
                    tab: 'text-center transition-all duration-300 items-center py-5 px-5 text-center border-b-2 text-sm leading-5  text-gray-500 border-transparent hover:text-gray-700 hover:border-gray-300 focus:text-gray-700',
                    tabSelected:
                        'text-center transition-all duration-300 py-5 px-5 text-center border-b-2 font-medium text-sm leading-5  text-primary-500 border-primary-400',
                    grayActiveRounded:
